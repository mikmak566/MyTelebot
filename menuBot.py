...
m_fun = Menu("Развлечения", buttons=["Зоопарк", "Прислать анекдот", "Прислать фильм", "Выход"], parent=m_main)

m_zoo = Menu("Зоопарк", buttons=["Прислать аксолотля", "Прислать лисёнка", "Прислать котика", "Прислать собаку", "Выход"], parent=m_main)